...
namespace EduX_Proj.Controllers
{
    ...
    public class AlunoTurmasController : ControllerBase
    {
        ...
        public IActionResult Get()
        {
            try
            {
                var alunos = _alunoTurmaRepository.ListarTodos();
        ...
        public IActionResult Get(int id)
        {
            try
            {
                AlunoTurma aluno = _alunoTurmaRepository.BuscarPorID(id);
        ...
        public IActionResult Post(AlunoTurma a)
        {
            try
            {
                _alunoTurmaRepository.Adicionar(a);
        ...
        public IActionResult Put(int id, AlunoTurma a)
        {
            try
            {
                _alunoTurmaRepository.Alterar(id, a);
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                var aluno = _alunoTurmaRepository.BuscarPorID(id);
